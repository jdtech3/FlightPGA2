...
MEM_2 := Computer_System_VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
$(MEM_2)_NAME := VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
...
$(MEM_2)_START := 0x09000000
$(MEM_2)_END := 0x09001fff
$(MEM_2)_SPAN := 0x00002000
$(MEM_2)_HIERARCHICAL_PATH := VGA_Subsystem.Char_Buf_Subsystem.Onchip_SRAM
$(MEM_2)_WIDTH := 32
...
VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
